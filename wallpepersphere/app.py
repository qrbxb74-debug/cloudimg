...
# Dynamically add production URL if it exists to keep it out of version control
if PRODUCTION_URL:
    client_secrets['web']['redirect_uris'].append(f"{PRODUCTION_URL}/login/google/callback")
...
queue_manager = UploadQueueManager(visual_recognizer, temp_storage_path=QUEUE_STORAGE, rate_limit_seconds=1.0)
